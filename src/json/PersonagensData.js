const PersonagensData = [
  ...
  },
  {
    ...
    login: "gabryel",
    senha: "123321",
    imagem: require("../images/jin.jpeg"),
    n_reg_pokedex: 64,
    alinhamento: "Leal e Mau",
    classe: ["Pesquisador", "Professor", "Ocultista", "Rúnico"],
    nivel: 25,
    titulo_ou_afiliacao: null,
    status: {
      saude: 10,
    ...
    pericias: ["Manipulação", "História", "Empatia", "Engenharia"],
    talentos: [
      "Armas",
      "Pokedex",
      "Rotina de Estudos",
      "Deixa Ajudar com Isso!",
      "Deixa Ajudar Agora!",
      "Estudo Comportamental",
      "Enciclopédia",
      "Coordenação",
      "Estudo Comportamental +",
      "Hipótese dos Atributos",
      "Hipótese dos Atributos +",
    ...
    pokemons: [
      {
        ...
        habilidades: ["Foco Interior", "Justiceiro"],
      ...
      },
      {
        ...
        habilidades: ["Metamorfose", "Vínculo Profundo"],
        caracteristicas: ["Manancial", "Silêncio"],
      },
      {
        id: 3,
        nome: "Haxorus",
        ...
        habilidades: ["Quebra Moldes", "Tensão"],
        caracteristicas: ["Aura", "Hierarquia"],
      },
      {
        id: 4,
        nome: "Infernape",
        ...
        habilidades: ["Punho de Ferro", "Gula"],
        caracteristicas: ["Afundamento", "Calor", "Combustão", "Escalada"],
      },
      {
        id: 5,
        nome: "Gliscor",
        ...
        habilidades: ["Hipercorte", "Veneno Curador"],
  ...
  },
  {
    ...
    pericias: ["Intimidação", "Manipulação", "Força", "Percepção", "Empatia"],
    talentos: [
      "Armas",
      "Pokedex",
      "Aguento Outra!",
